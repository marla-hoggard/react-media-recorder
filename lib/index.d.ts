...
export declare function useReactMediaRecorder({ audio, video, onStart, onStop, blobPropertyBag, screen, mediaRecorderOptions, customMediaStream, stopStreamsOnStop, }: ReactMediaRecorderHookProps): ReactMediaRecorderRenderProps;
